...
import { Rocket, CheckCircle2, ArrowRight, Code, Layout, Brain, Globe, Smartphone, Server } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-bg-dark text-white pt-32 pb-20 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10">
        ...
        <div className="glass rounded-[3rem] border border-white/10 p-8 md:p-16 relative overflow-hidden">
          ...
          <form className="space-y-12">
            ...
            <div className="pt-6">
              <button className="w-full py-6 bg-brand-primary text-black font-display font-bold uppercase tracking-[0.3em] rounded-2xl flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-[0_0_40px_rgba(34,211,238,0.4)] group">
