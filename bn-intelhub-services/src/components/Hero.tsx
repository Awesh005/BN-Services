...
import { RotatingSphere } from './three/RotatingSphere';
      ...
      <div className="relative z-20 container mx-auto px-6 text-center pointer-events-none">
        ...
        >
          <h1 className="text-5xl md:text-7xl lg:text-9xl font-display font-bold tracking-tight leading-[0.9] mb-8">
            Next-Gen <br />
            <span className="text-gradient drop-shadow-[0_0_30px_rgba(0,242,255,0.3)]">AI Solutions</span>
          </h1>
        </motion.div>
        ...
        >
          ...
          <button className="px-10 py-5 glass rounded-full font-mono font-bold uppercase tracking-wider text-white hover:bg-white/10 transition-all border-white/20 hover:border-brand-primary/50">
            View Ecosystem
          </button>
        </motion.div>
      </div>
